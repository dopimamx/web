...
(function(){
  ...
  <nav class="nav">
    <div class="container-wide nav-inner">
      <a href="../Landing Page.html" class="logo-wordmark" aria-label="dopima">dopima</a>
      <div class="nav-links">
        <a href="../Landing Page.html#como-funciona">Cómo funciona</a>
        <a href="../Landing Page.html#incluye">Qué incluye</a>
        <a href="../Landing Page.html#sectores">Para quién</a>
        <a href="../Landing Page.html#nosotros">Nosotros</a>
      </div>
  ...
  <footer>
    <div class="container-wide">
      <div class="foot-grid">
        <div>
          <a href="../Landing Page.html" class="logo-wordmark on-dark">dopima</a>
          <p class="foot-tagline">Infraestructura comercial para empresas que están cansadas de vender a pulso.</p>
        </div>
        <div>
          <h4>Navegación</h4>
          <ul>
            <li><a href="../Landing Page.html#como-funciona">Cómo funciona</a></li>
            <li><a href="../Landing Page.html#incluye">Qué incluye</a></li>
            <li><a href="../Landing Page.html#sectores">Para quién</a></li>
            <li><a href="../Landing Page.html#nosotros">Nosotros</a></li>
          </ul>
        </div>
        <div>
          <h4>Legal</h4>
      ...
      <div class="foot-bottom">
        <span>© 2026 DOPIMA · HECHO EN MÉXICO · dopima.com</span>
