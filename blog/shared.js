  ...
  <nav class="nav" aria-label="Principal">
    <div class="container nav-inner">
      ...
      <div class="nav-links" id="navLinks">
        <a href="${homeHref}#por-que">Por qué Clientify</a>
        <a href="${homeHref}#planes">Planes</a>
        <a href="${homeHref}#industrias">Industrias</a>
        <a href="${homeHref}#prueba-gratis">Prueba gratis</a>
      ...
      <a href="${WA}" target="_blank" rel="noopener" class="btn btn-wa nav-cta" aria-label="Hablar con Dopima por WhatsApp">
        ${waIcon}
        <span class="nav-cta-text">Hablar por WhatsApp</span>
      </a>
    ...
    <div class="nav-mobile" id="navMobile" role="menu" aria-hidden="true">
      <a href="${homeHref}#por-que" role="menuitem">Por qué Clientify</a>
      <a href="${homeHref}#planes" role="menuitem">Planes</a>
      <a href="${homeHref}#industrias" role="menuitem">Industrias</a>
      <a href="${homeHref}#prueba-gratis" role="menuitem">Prueba gratis</a>
    ...
    <div class="container">
      <div class="foot-grid">
        <div>
          ...
          <p class="foot-tagline">Partner Oficial Clientify. Implementamos sistemas comerciales llave en mano para empresas medianas en México y LATAM.</p>
        </div>
        <div>
          <h4>Producto</h4>
          <ul>
            <li><a href="${homeHref}#por-que">Por qué Clientify</a></li>
            <li><a href="${homeHref}#planes">Planes</a></li>
            <li><a href="${homeHref}#industrias">Industrias</a></li>
            <li><a href="${homeHref}#prueba-gratis">Prueba 14 días gratis</a></li>
      ...
      <div class="foot-bottom">
        <span>© Dopima · 2026 · Todos los derechos reservados</span>
        <span>Hecho con café y dopamina.</span>
      </div>
    </div>
  </footer>`;
